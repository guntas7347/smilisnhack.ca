            ...
            <form className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div className="relative">
                  ...
                  <select className="h-14 pl-5 pr-10 w-full rounded-2xl bg-white/70 dark:bg-white/5 border border-white/40 dark:border-white/10 text-text-primary dark:text-white appearance-none">
              ...
              <button
                type="button"
                className="w-full h-16 bg-gradient-to-r from-primary to-secondary text-white text-lg font-black rounded-2xl flex items-center justify-center gap-3 hover:-translate-y-0.5 transition-all"
              >
                Get a Quote
