      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          <Link href="/" className="flex items-center space-x-2 group">
            <div className="bg-gradient-to-br from-pink-500 to-rose-500 p-2 rounded-xl transform group-hover:rotate-12 transition-transform">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link
              href="/contact"
              className="bg-gradient-to-r from-pink-500 to-rose-500 text-white px-6 py-2.5 rounded-full hover:shadow-lg hover:shadow-pink-300 transition-all transform hover:scale-105"
            >
              Book Now
            </Link>
          </div>
  ...
  return (
    <footer className="bg-gradient-to-br from-gray-900 via-pink-900 to-rose-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="space-y-2">
              <Link
                href="/"
                className="block text-pink-200 hover:text-white transition-colors text-sm"
              >
                Home
              </Link>
              <Link
        ...
        <div className="border-t border-pink-800 mt-8 pt-8 text-center text-pink-200 text-sm">
